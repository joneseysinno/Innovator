use crate::particles::{FieldParticle, Particle, SourceParticle, StackParticle, SurfaceParticle};
...
pub struct EngineerInput {
    ...
    pub label_id: crate::particles::ParticleId,
    pub field_id: crate::particles::ParticleId,
    pub unit_id: crate::particles::ParticleId,
}
